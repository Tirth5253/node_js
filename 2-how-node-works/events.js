...
//so the "event emiter" means the thing that can cause the event to emit   EX. in react or html clicking on button can cause the event so button can be emiter
