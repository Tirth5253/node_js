...
exports.createTour = (req, res) => {
  ...
  //     (err) => {
  res.status(201).json({
                                                                                                 //in this code once we updated the array called "newTour" then we write it in the file , then further code says that we have send it to the client so in postman we can see that
    status: "success",
    // data: {
    //   tour: newTour,
    // },
